  ...
  >
    <G clipPath="url(#a)">
      <G clipPath="url(#b)">
        <Path
          fill="#555"
          d="M20.328 12.758c-.023-.05-.565-1.254-1.771-2.46-1.607-1.607-3.637-2.456-5.871-2.456-2.234 0-4.264.849-5.871 2.456-1.206 1.206-1.751 2.412-1.771 2.46a.513.513 0 0 0 0 .417c.022.05.565 1.253 1.77 2.46 1.608 1.606 3.638 2.455 5.872 2.455s4.264-.85 5.87-2.456c1.207-1.206 1.75-2.409 1.772-2.46a.513.513 0 0 0 0-.416Zm-7.642 4.307c-1.972 0-3.694-.717-5.12-2.13a8.552 8.552 0 0 1-1.478-1.97 8.538 8.538 0 0 1 1.478-1.969c1.426-1.413 3.148-2.13 5.12-2.13 1.971 0 3.694.717 5.12 2.13a8.548 8.548 0 0 1 1.48 1.97c-.462.862-2.474 4.099-6.6 4.099Zm0-7.174a3.074 3.074 0 1 0 0 6.148 3.074 3.074 0 0 0 0-6.148Zm0 5.124a2.05 2.05 0 1 1 0-4.1 2.05 2.05 0 0 1 0 4.1Z"
        />
      </G>
    </G>
    <Defs>
      <ClipPath id="a">
        <Path fill="#fff" d="M4.487 4.767h16.397v16.397H4.487z" />
      </ClipPath>
      <ClipPath id="b">
        <Path fill="#fff" d="M4.487 4.767h16.397v16.397H4.487z" />
      </ClipPath>
...
<path d="M20.3277 12.7582C20.3052 12.7076 19.7627 11.5041 18.5566 10.298C16.9496 8.69099 14.9198 7.84167 12.6857 7.84167C10.4516 7.84167 8.42183 8.69099 6.81479 10.298C5.60871 11.5041 5.06363 12.7096 5.04378 12.7582C5.01464 12.8238 4.99959 12.8947 4.99959 12.9664C4.99959 13.0381 5.01464 13.109 5.04378 13.1746C5.0662 13.2252 5.60871 14.4281 6.81479 15.6341C8.42183 17.2405 10.4516 18.0899 12.6857 18.0899C14.9198 18.0899 16.9496 17.2405 18.5566 15.6341C19.7627 14.4281 20.3052 13.2252 20.3277 13.1746C20.3568 13.109 20.3719 13.0381 20.3719 12.9664C20.3719 12.8947 20.3568 12.8238 20.3277 12.7582ZM12.6857 17.065C10.7142 17.065 8.99189 16.3483 7.56611 14.9353C6.98112 14.3535 6.48341 13.6901 6.08845 12.9658C6.48325 12.2413 6.98098 11.5779 7.56611 10.9962C8.99189 9.58323 10.7142 8.86649 12.6857 8.86649C14.6572 8.86649 16.3795 9.58323 17.8053 10.9962C18.3915 11.5778 18.8903 12.2412 19.2862 12.9658C18.8244 13.8279 16.8125 17.065 12.6857 17.065ZM12.6857 9.89131C12.0776 9.89131 11.4832 10.0716 10.9776 10.4095C10.4721 10.7473 10.078 11.2274 9.84529 11.7892C9.6126 12.351 9.55171 12.9692 9.67034 13.5656C9.78897 14.1619 10.0818 14.7098 10.5118 15.1397C10.9417 15.5697 11.4895 15.8625 12.0859 15.9811C12.6823 16.0998 13.3005 16.0389 13.8623 15.8062C14.424 15.5735 14.9042 15.1794 15.242 14.6738C15.5799 14.1683 15.7602 13.5738 15.7602 12.9658C15.7593 12.1506 15.4351 11.3691 14.8588 10.7927C14.2824 10.2163 13.5009 9.89216 12.6857 9.89131ZM12.6857 15.0154C12.2803 15.0154 11.8841 14.8952 11.547 14.67C11.2099 14.4448 10.9472 14.1247 10.7921 13.7501C10.637 13.3756 10.5964 12.9635 10.6755 12.5659C10.7546 12.1683 10.9498 11.8031 11.2364 11.5165C11.5231 11.2298 11.8883 11.0346 12.2859 10.9555C12.6834 10.8764 13.0956 10.917 13.4701 11.0721C13.8446 11.2273 14.1647 11.49 14.3899 11.827C14.6151 12.1641 14.7354 12.5604 14.7354 12.9658C14.7354 13.5094 14.5194 14.0307 14.135 14.4151C13.7506 14.7995 13.2293 15.0154 12.6857 15.0154Z" fill="#555555"/>
</g>
</g>
<defs>
<clipPath id="clip0_17_96">
<rect width="16.3971" height="16.3971" fill="white" transform="translate(4.48718 4.76721)"/>
</clipPath>
