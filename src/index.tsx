...
console.log({item});
 ...
 , trigger: 'on press'
        ...
        `{ width: "fit-content", minWidth: 180, height: 30, backgroundColor: "$var_all.colors.primary", borderRadius: 20, alignItems: "center", justifyContent: "center" }`, `{ color: "#FFF" }`],
        ...
        `{ width: "80%", maxWidth: 280, minHeight: 150, backgroundColor: "#FFF", borderRadius: 20 }`, `{ alignItems: "center", justifyContent: "center" }`],
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            styles:[`{ width: "fit-content", minWidth: 180, height: 30, backgroundColor: "$var_all.colors.primary", borderRadius: 20, alignItems: "center", justifyContent: "center" }`],
